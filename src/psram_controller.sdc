...
//Created Time: 2023-05-04 16:23:29
create_clock -name clk_sys -period 37.037 -waveform {0 18.518} [get_ports {sys_clk}]
create_generated_clock -name clk_pll_mem -source [get_ports {sys_clk}] -master_clock clk_sys -divide_by 2 -multiply_by 5 [get_nets {clk}]
